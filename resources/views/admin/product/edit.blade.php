                        ...
                        <form action="{{ route('product.update',$product->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="long_description" id="long_description" class="textarea">{{ $product->long_description }}</textarea>
                                </div>
                                <br><br>
